...
// mruby
#define COCOAPODS_POD_AVAILABLE_mruby
#define COCOAPODS_VERSION_MAJOR_mruby 0
#define COCOAPODS_VERSION_MINOR_mruby 1
#define COCOAPODS_VERSION_PATCH_mruby 0
